...
DEFINE_string(
    ...
    "then do the ycsb running, the differences are whether we will trigger "
    "additional read/write operation while executing ycsb_running");
...
int migration_bench_tool(int argc, char** argv) {
